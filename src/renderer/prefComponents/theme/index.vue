<template>
  <div class="pref-theme">
    ...
    <separator></separator>
    <cur-select
      description="category.themeChild.subjectFollowSystem"
    ...
    <section v-show="false" class="import-themes ag-underdevelop">
      <div>
        <span>{{$t('category.themeChild.openTheThemesFolder')}}</span>
        <el-button size="small">{{$t('category.themeChild.openFolder')}}</el-button>
      </div>

      <div>
        <span>{{$t('category.themeChild.importCustomThemes')}}</span>
        <el-button size="small">{{$t('category.themeChild.importTheme')}}</el-button>
      </div>
    </section>
  </div>
</template>
